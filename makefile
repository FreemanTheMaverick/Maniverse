...
# IF $(LANG) is "__PYTHON__", you need to set $(PYTHON3) and $(PYBIND11).
...
export GeneralFlags = -Wall -Wextra -Wpedantic -O3 -std=c++17 -fPIC -D$(LANG)
